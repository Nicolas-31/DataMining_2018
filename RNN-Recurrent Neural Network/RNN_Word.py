"""
Word RNN model. Original by Andrej Karpathy (@karpathy)
BSD License
"""
import numpy as np
...
while doRun:
    ...
    inputs = [word_to_ix[wd] for wd in words[p:p + seq_length]]
    targets = [word_to_ix[wd] for wd in words[p + 1:p + seq_length + 1]]
